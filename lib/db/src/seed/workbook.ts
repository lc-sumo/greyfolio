...
export const PRODUCTS: readonly ProductRule[] = [
  ...
  { name: 'CONSOLIDATION - UPFRONT COMM', kind: 'consolidation-upfront', basis: 'funded', factor: true, term: true, parent: false, comm: 0.1, clawback: true, renewal: true, multiDraw: true, drawInitial: 0.1, drawSubsequent: 0.05, incremental: true },
  { name: 'CONSOLIDATION DISBURSEMENT', kind: 'consolidation-backend', basis: 'draw', factor: false, term: false, parent: true, comm: 0.05, clawback: true, renewal: false, multiDraw: false, drawInitial: null, drawSubsequent: null, incremental: true },
  { name: 'REVERSE - TOTAL FUNDING', kind: 'consolidation-upfront', basis: 'payback', factor: true, term: true, parent: false, comm: 0.06, clawback: true, renewal: true, multiDraw: true, drawInitial: 0.06, drawSubsequent: 0.06 },
  { name: 'REVERSE - DISBURSEMENT', kind: 'consolidation-backend', basis: 'draw', factor: false, term: false, parent: true, comm: 0.06, clawback: true, renewal: false, multiDraw: false, drawInitial: null, drawSubsequent: null },

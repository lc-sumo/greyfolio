...
export const PRODUCTS: readonly ProductRule[] = [
  ...
  { name: 'CONSOLIDATION - UPFRONT COMM', basis: 'funded', factor: true, term: true, parent: false, comm: 0.1, clawback: true, renewal: true, multiDraw: true, drawInitial: 0.1, drawSubsequent: 0.05 },
  { name: 'CONSOLIDATION DISBURSEMENT', basis: 'draw', factor: false, term: false, parent: true, comm: 0.05, clawback: true, renewal: false, multiDraw: false, drawInitial: null, drawSubsequent: null },
